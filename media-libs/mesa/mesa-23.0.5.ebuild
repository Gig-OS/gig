...
PATCHES=(
	"${FILESDIR}"/0001-gallivm-llvm17-deleted-includefiles.patch
	"${FILESDIR}"/21124.patch
	"${FILESDIR}"/21125.patch
	"${FILESDIR}"/21262.patch
	"${FILESDIR}"/21263.patch
	"${FILESDIR}"/4ee15720087d0b76423581aef14a98682c42558f.patch
...
multilib_src_configure() {
	...
	local vulkan_layers
	use vulkan && vulkan_layers+="device-select,intel-nullhw"
